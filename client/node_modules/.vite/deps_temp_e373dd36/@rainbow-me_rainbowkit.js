...
import {
  ...
  withRetry,
  withTimeout
} from "./chunk-XW5WBJUF.js";
import "./chunk-JATJNFCD.js";
import {
  BaseError,
  ...
  validate,
  validate2
} from "./chunk-PIOIAP52.js";
import "./chunk-ALUSTTMD.js";
import {
  mainnet
} from "./chunk-S2X4WKEZ.js";
import "./chunk-74RGHA5X.js";
import "./chunk-SYIK76NT.js";
import {
  ...
  isAddress,
  numberToHex
} from "./chunk-XEGSJ7RT.js";
import {
  formatAbi,
  formatAbiItem,
  parseAbi
} from "./chunk-VXYLA3RX.js";
import "./chunk-W7ITMLYB.js";
import "./chunk-ZCL2KDFK.js";
import {
  RemoveScrollBar,
  createSidecarMedium,
  exportSidecar,
  ...
  useMergeRefs,
  zeroRightClassName
} from "./chunk-PCHHWODF.js";
import {
  __assign,
  __rest,
  __spreadArray,
  init_tslib_es6
} from "./chunk-IJKRMHR4.js";
import {
  useQuery
} from "./chunk-7ZBMOHKP.js";
import {
  clsx_default
} from "./chunk-LPO6FEV6.js";
import {
  require_react_dom
} from "./chunk-VEXAI7EY.js";
import {
  require_jsx_runtime
} from "./chunk-VPZ6USF7.js";
import {
  require_react
} from "./chunk-FCFS644U.js";
import {
  __commonJS,
  __export,
  __publicField,
...
function Field(ORDER, bitLenOrOpts, isLE2 = false, opts = {}) {
  ...
  const f = Object.freeze({
    ...
    toBytes: (num2) => isLE2 ? numberToBytesLE(num2, BYTES2) : numberToBytesBE(num2, BYTES2),
    fromBytes: (bytes) => {
...
function _createCurveFields(type6, CURVE, curveOpts = {}) {
...
function weierstrassN(CURVE, curveOpts = {}) {
  ...
  const toBytes11 = curveOpts.toBytes || pointToBytes2;
  ...
  class Point3 {
    ...
    static fromHex(hex2) {
      const P = Point3.fromAffine(fromBytes7(ensureBytes("pointHex", hex2)));
      P.assertValidity();
      return P;
    }
    ...
    toBytes(isCompressed = true) {
      abool("isCompressed", isCompressed);
      this.assertValidity();
      return toBytes11(Point3, this, isCompressed);
    }
...
function ecdsa(Point3, ecdsaOpts, curveOpts = {}) {
  ...
  function verify6(signature, msgHash, publicKey, opts = defaultVerOpts) {
    ...
    validateSigVerOpts(opts);
    const { lowS, prehash, format: format6 } = opts;
    if ("strict" in opts)
      throw new Error("options.strict was renamed to lowS");
    if (format6 !== void 0 && !["compact", "der", "js"].includes(format6))
      throw new Error('format must be "compact", "der" or "js"');
    const isHex = typeof sg === "string" || isBytes(sg);
    const isObj = !isHex && !format6 && typeof sg === "object" && sg !== null && typeof sg.r === "bigint" && typeof sg.s === "bigint";
    if (!isHex && !isObj)
...
function createCurve(curveDef, defHash) {
  const create5 = (hash8) => weierstrass({ ...curveDef, hash: hash8 });
...
function psiFrobenius(Fp3, Fp22, base3) {
  const PSI_X = Fp22.pow(base3, (Fp3.ORDER - _1n6) / _3n4);
  const PSI_Y = Fp22.pow(base3, (Fp3.ORDER - _1n6) / _2n5);
  function psi(x, y) {
    const x2 = Fp22.mul(Fp22.frobeniusMap(x, 1), PSI_X);
    const y2 = Fp22.mul(Fp22.frobeniusMap(y, 1), PSI_Y);
    return [x2, y2];
  }
  const PSI2_X = Fp22.pow(base3, (Fp3.ORDER ** _2n5 - _1n6) / _3n4);
  const PSI2_Y = Fp22.pow(base3, (Fp3.ORDER ** _2n5 - _1n6) / _2n5);
...
function tower12(opts) {
  ...
  function isValidC(num2, ORDER2) {
    return typeof num2 === "bigint" && _0n6 <= num2 && num2 < ORDER2;
  }
...
function signatureG2FromBytes(hex2) {
  ...
  const is0 = y1 === _0n7 && y0 * _2n6 / P !== aflag1;
  if (isGreater || is0)
    y = Fp2.neg(y);
  const point = Point3.fromAffine({ x, y });
  point.assertValidity();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-DGSF7XSW.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-3G2GBPDF.js");
    ...
    async getProvider() {
      async function initProvider() {
        ...
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-FL4BDS7S.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-BNZH5KE3.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-NNRX6L5X.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-FETPFHEV.js");
...
var fetchTranslations = async (locale) => {
  switch (locale) {
    case "ar":
    case "ar-AR":
      return (await import("./ar_AR-CTNWGWSS-GWOHIUFD.js")).default;
    case "de":
    case "de-DE":
      return (await import("./de_DE-P43L3PR7-FEDV3A6S.js")).default;
    case "en":
    case "en-US":
      return (await import("./en_US-RFN65H63-RRG6LSPO.js")).default;
    case "es":
    case "es-419":
      return (await import("./es_419-JBX5FS3Q-CMSWGU4F.js")).default;
    case "fr":
    case "fr-FR":
      return (await import("./fr_FR-CM2EDAQC-KPTH3H3P.js")).default;
    case "hi":
    case "hi-IN":
      return (await import("./hi_IN-GYVCUYRD-WQ3G7TAI.js")).default;
    case "id":
    case "id-ID":
      return (await import("./id_ID-7ZWSMOOE-CGDNE22E.js")).default;
    case "ja":
    case "ja-JP":
      return (await import("./ja_JP-CGMP6VLZ-4NCGYCD7.js")).default;
    case "ko":
    case "ko-KR":
      return (await import("./ko_KR-YCZDTF7X-7XNMA5ST.js")).default;
    case "ms":
    case "ms-MY":
      return (await import("./ms_MY-5LHAYMS7-FUBHMXKB.js")).default;
    case "pt":
    case "pt-BR":
      return (await import("./pt_BR-3JTS4PSK-AJLRHCRI.js")).default;
    case "ru":
    case "ru-RU":
      return (await import("./ru_RU-6J6XERHI-WEQE6734.js")).default;
    case "th":
    case "th-TH":
      return (await import("./th_TH-STXOD4CR-VKJ6S4ED.js")).default;
    case "tr":
    case "tr-TR":
      return (await import("./tr_TR-P7QAUUZU-KF23TOBE.js")).default;
    case "ua":
    case "uk-UA":
      return (await import("./uk_UA-JTTBGJGQ-OLZ6QITV.js")).default;
    case "vi":
    case "vi-VN":
      return (await import("./vi_VN-5XUUAVWW-Z7VAG5T2.js")).default;
    case "zh":
    case "zh-CN":
    case "zh-Hans":
      return (await import("./zh_CN-RGMLPFEP-ANQRCR5P.js")).default;
    case "zh-HK":
      return (await import("./zh_HK-YM3T6EI5-VBE23Y2K.js")).default;
    case "zh-Hant":
    case "zh-TW":
      return (await import("./zh_TW-HAEH6VE5-WRGRQE5E.js")).default;
    default:
      return (await import("./en_US-RFN65H63-RRG6LSPO.js")).default;
  }
};
...
var apeChainIcon = {
  ...
  iconUrl: async () => (await import("./apechain-SX5YFU6N-6WMFVHPM.js")).default
};
var arbitrumIcon = {
  iconBackground: "#96bedc",
  iconUrl: async () => (await import("./arbitrum-WURIBY6W-OIBMMLXU.js")).default
};
var avalancheIcon = {
  iconBackground: "#e84141",
  iconUrl: async () => (await import("./avalanche-KOMJD3XY-3HQDCNOT.js")).default
};
var baseIcon = {
  iconBackground: "#0052ff",
  iconUrl: async () => (await import("./base-OAXLRA4F-P7H5KDPA.js")).default
};
var berachainIcon = {
  iconBackground: "#814625",
  iconUrl: async () => (await import("./berachain-NJECWIVC-NMMPYBDV.js")).default
};
var blastIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./blast-V555OVXZ-2BKCCPEZ.js")).default
};
var bscIcon = {
  iconBackground: "#ebac0e",
  iconUrl: async () => (await import("./bsc-N647EYR2-3QG4LUZH.js")).default
};
var celoIcon = {
  iconBackground: "#FCFF52",
  iconUrl: async () => (await import("./celo-GEP4TUHG-N23KAKUK.js")).default
};
var cronosIcon = {
  iconBackground: "#002D74",
  iconUrl: async () => (await import("./cronos-HJPAQTAE-VDG2THTS.js")).default
};
var degenIcon = {
  iconBackground: "#A36EFD",
  iconUrl: async () => (await import("./degen-FQQ4XGHB-YR6YWAXA.js")).default
};
var ethereumIcon = {
  iconBackground: "#484c50",
  iconUrl: async () => (await import("./ethereum-RGGVA4PY-MYI6YE5Y.js")).default
};
var flowIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./flow-5FQJFCTK-LXHED4SH.js")).default
};
var gnosisIcon = {
  iconBackground: "#04795c",
  iconUrl: async () => (await import("./gnosis-37ZC4RBL-PR2B7YHQ.js")).default
};
var gravityIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./gravity-J5YQHTYH-PUOJFKWH.js")).default
};
var hardhatIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./hardhat-TX56IT5N-UEKUFXRY.js")).default
};
var hyperevmIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./hyperevm-VKPAA4SA-URAQONKM.js")).default
};
var inkIcon = {
  iconBackground: "#7132F5",
  iconUrl: async () => (await import("./ink-FZMYZWHG-GHQMXNX5.js")).default
};
var kaiaIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./kaia-65D2U3PU-CVP7XHI6.js")).default
};
var lineaIcon = {
  iconBackground: "#ffffff",
  iconUrl: async () => (await import("./linea-QRMVQ5DY-IRUESVU4.js")).default
};
var mantaIcon = {
  iconBackground: "#ffffff",
  iconUrl: async () => (await import("./manta-SI27YFEJ-SRCBO3MU.js")).default
};
var mantleIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./mantle-CKIUT334-V5IDUXZ5.js")).default
};
var optimismIcon = {
  iconBackground: "#ff5a57",
  iconUrl: async () => (await import("./optimism-HAF2GUT7-NWXHX5OR.js")).default
};
var polygonIcon = {
  iconBackground: "#9f71ec",
  iconUrl: async () => (await import("./polygon-WW6ZI7PM-CPKFGL5P.js")).default
};
var roninIcon = {
  iconBackground: "#1273EA",
  iconUrl: async () => (await import("./ronin-EMCPYXZT-SQFIYIE3.js")).default
};
var sankoIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./sanko-RHQYXGM5-V24LQNEX.js")).default
};
var superpositionIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./superposition-HG6MMR2Y-3DBBH2OU.js")).default
};
var scrollIcon = {
  iconBackground: "#FFEEDA",
  iconUrl: async () => (await import("./scroll-5OBGQVOV-E6CITKYX.js")).default
};
var unichainIcon = {
  iconBackground: "#F50DB4",
  iconUrl: async () => (await import("./unichain-C5BWO2ZY-7HIOQEKF.js")).default
};
var xdcIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./xdc-KJ3TDBYO-K22JT4XH.js")).default
};
var zetachainIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./zetachain-TLDS5IPW-2X5WLWAF.js")).default
};
var zkSyncIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./zksync-DH7HK5U4-2T3UK5N6.js")).default
};
var zoraIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./zora-FYL5H3IO-B3C63ANM.js")).default
};
...
var src = async () => (await import("./assets-Q6ZU7ZJ5-6PDTTEX3.js")).default;
...
var src2 = async () => (await import("./login-UP3DZBGS-6PCNKXCS.js")).default;
...
var signInIcon = async () => (await import("./sign-A7IJEUT5-NEINCLHH.js")).default;
function SignIn({
  onClose,
  onCloseModal
}) {
...
var src3 = async () => (await import("./connect-UA7M4XW6-D6OPUEEH.js")).default;
...
var src4 = async () => (await import("./create-FASO7PVG-MLWJXDSB.js")).default;
...
var src5 = async () => (await import("./refresh-S4T5V5GX-DRQUFJ5H.js")).default;
...
var src6 = async () => (await import("./scan-4UYSQ56Q-HBO2QJWK.js")).default;
...
var getBrowserSrc = async () => {
  ...
  switch (browser) {
    case "Arc":
      return (await import("./Arc-VDBY7LNS-CL4IEZDR.js")).default;
    case "Brave":
      return (await import("./Brave-BRAKJXDS-BAOOAAAP.js")).default;
    case "Chrome":
      return (await import("./Chrome-65Q5P54Y-FNNN7SJZ.js")).default;
    case "Edge":
      return (await import("./Edge-XSPUTORV-HRKZLUKP.js")).default;
    case "Firefox":
      return (await import("./Firefox-AAHGJQIP-E6YJVNO7.js")).default;
    case "Opera":
      return (await import("./Opera-KQZLSACL-DDRPRQOJ.js")).default;
    case "Safari":
      return (await import("./Safari-ZPL37GXR-SRSQ27OZ.js")).default;
    default:
      return (await import("./Browser-76IHF3Y2-BYKYTHNH.js")).default;
  }
};
...
var getPlatformSrc = async () => {
  ...
  switch (platform) {
    case "Windows":
      return (await import("./Windows-PPTHQER6-C2262FMF.js")).default;
    case "macOS":
      return (await import("./Macos-MW4AE7LN-AXTQFP2K.js")).default;
    case "Linux":
      return (await import("./Linux-OO4TNCLJ-X766COJR.js")).default;
    default:
      return (await import("./Linux-OO4TNCLJ-X766COJR.js")).default;
  }
};
...
var coinbaseWallet2 = ({ appName, appIcon }) => {
  ...
  return {
    ...
    shortName: "Coinbase",
    rdns: "com.coinbase.wallet",
    iconUrl: async () => (await import("./coinbaseWallet-OKXU3TRC-5WTY6V3G.js")).default,
    iconAccent: "#2c5ff6",
...
var metaMaskWallet = ({
  ...
  return {
    ...
    name: "MetaMask",
    rdns: "io.metamask",
    iconUrl: async () => (await import("./metaMaskWallet-SITXT2FV-2WZALIDC.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var rainbowWallet = ({
  ...
  return {
    ...
    name: "Rainbow",
    rdns: "me.rainbow",
    iconUrl: async () => (await import("./rainbowWallet-O26YNBMX-GIRBKUUB.js")).default,
...
var safeWallet = () => ({
  ...
  iconAccent: "#12ff80",
  iconBackground: "#fff",
  iconUrl: async () => (await import("./safeWallet-5MNKTR5Z-K3KTKP4J.js")).default,
  installed: (
...
var walletConnectWallet = ({
  ...
  return {
    ...
    name: "WalletConnect",
    installed: void 0,
    iconUrl: async () => (await import("./walletConnectWallet-YHWKVTDY-PWKXK2YF.js")).default,
