...
var ICONS = {
  add: async () => (await import("./add-TUFKYXXU.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-DN7BC4WI.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-EBSKD2IH.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-IR35ALMW.js")).appStoreSvg,
  apple: async () => (await import("./apple-K6XMEEPJ.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-XAPPJXAX.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-ZMIC3B5W.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-YAYD7QI2.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-JA7M2QND.js")).arrowTopSvg,
  bank: async () => (await import("./bank-GODZ575S.js")).bankSvg,
  browser: async () => (await import("./browser-2CJW3SOX.js")).browserSvg,
  card: async () => (await import("./card-ZNV75NMR.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-TT2T4UP7.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-C6CTOPSY.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-ZAN5YAJ6.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-I3CIDYTY.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-RDZV3TRF.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-NBUG6VYX.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-E3MIF67L.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-NGBP7KW4.js")).clockSvg,
  close: async () => (await import("./close-TIN7INWI.js")).closeSvg,
  compass: async () => (await import("./compass-IQMJ7SS3.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-RBKHK7NK.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-V6SE4YVX.js")).copySvg,
  cursor: async () => (await import("./cursor-DIHXOGER.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-ZBPVIJAB.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-NJOARJ2U.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-64S4K3Y7.js")).disconnectSvg,
  discord: async () => (await import("./discord-J2GSM42E.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-5EZCF2PR.js")).etherscanSvg,
  extension: async () => (await import("./extension-EYPQ7CDW.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-5Q32C62R.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-43BQ2DLI.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-YS6QI2DH.js")).farcasterSvg,
  filters: async () => (await import("./filters-6GRBIR2P.js")).filtersSvg,
  github: async () => (await import("./github-Y6JV4BAI.js")).githubSvg,
  google: async () => (await import("./google-NAIL3SHN.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-6WCR3HAY.js")).helpCircleSvg,
  image: async () => (await import("./image-5CFD26H2.js")).imageSvg,
  id: async () => (await import("./id-Q5VVGOQO.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-23GPTNBE.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-6C72XITK.js")).lightbulbSvg,
  mail: async () => (await import("./mail-LIXZOBKN.js")).mailSvg,
  mobile: async () => (await import("./mobile-CZ6RYU3T.js")).mobileSvg,
  more: async () => (await import("./more-HEGUWWPO.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-JOKRSIDQ.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-DOGTTGGB.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-56BOHTKL.js")).offSvg,
  playStore: async () => (await import("./play-store-QWL2QZPN.js")).playStoreSvg,
  plus: async () => (await import("./plus-47SBGJPX.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-RLRX47I7.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-AYSMO6I2.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-VZUK452J.js")).refreshSvg,
  search: async () => (await import("./search-ZOHOCP7G.js")).searchSvg,
  send: async () => (await import("./send-PX6SR3EC.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-QPG5Z3OQ.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-GQYWLLA2.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-LFSHMVNJ.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-5LXWHOMS.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-LXXJNPSY.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-QKFYDTSO.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-UD6CCNL4.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-WQ3FE5PO.js")).twitchSvg,
  twitter: async () => (await import("./x-SWYD2WAL.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-QPPTP56V.js")).twitterIconSvg,
  verify: async () => (await import("./verify-JBQHUXBL.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-MMMTS6CS.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-IH4CVSGF.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-OLJEBLA7.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-OLJEBLA7.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-OLJEBLA7.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-TXFUIM2W.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-F354PV5Y.js")).warningCircleSvg,
  x: async () => (await import("./x-SWYD2WAL.js")).xSvg,
  info: async () => (await import("./info-ZINJ6W5R.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-FG522EQA.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-VLR6SXIK.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-H7XUVAFS.js.map
